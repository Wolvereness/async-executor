package com.wolvereness.commons.asynchronousexecutor;
 ...
 * are via {@link AsynchronousExecutor#finishActive()} or the {@link
 * AsynchronousExecutor#get(Object)} methods.
 * <ul>
 ...
 * 	callback that was registered, and performs any synchronous
 * 	calculations.
 *
 * @param <P> The type of parameter you provide to make the object that will
 * 	be created. It should implement {@link Object#hashCode()} and {@link
 * 	Object#equals(Object)} if you want to get the value early.
 ...
 * @param <E> A type of exception you may throw and expect to be handled by
 * 	the main thread
...
public final class AsynchronousExecutor<P, T, C, E extends Throwable> {
	...
	public static interface CallBackProvider<P, T, C, E extends Throwable> extends ThreadFactory {
		...
		/**
		 * Synchronous call, called multiple times, once per registered
		 * callback
		 *
		 * @param parameter parameter object provided
		 * @param object the previously created object
